...
try {
  ...
  console.warn('[API Proxy AI Personas] Failed to parse BACKEND_URL, using defaults');
}
...
export async function GET(request: NextRequest) {
  try {
    ...
    const options = {
      ...
      port: backendPort,
      path: `/api/proxy/ai/personas${searchParams.toString() ? '?' + searchParams.toString() : ''}`,
      method: 'GET',
      headers: {
