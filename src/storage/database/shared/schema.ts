...
export const robots = pgTable("robots", {
	...
	groupRef: varchar("group_ref", { length: 36 }),
	roleRef: varchar("role_ref", { length: 36 }),
	...
	index("idx_robots_group_ref").using("btree", table.groupRef.asc().nullsLast().op("text_ops")),
	...
	index("idx_robots_role_ref").using("btree", table.roleRef.asc().nullsLast().op("text_ops")),
...
export const sessions = pgTable("sessions", {
	...
	index("idx_sessions_group_ref").using("btree", table.groupRef.asc().nullsLast().op("text_ops")),
...
export const messages = pgTable("messages", {
	...
	index("messages_intent_ref_idx").using("btree", table.intentRef.asc().nullsLast().op("text_ops")),
